  ...
  return (
    <Router>
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <a className="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#"><img height="150" width="120" src="https://odesk-prod-portraits.s3.amazonaws.com/Companies:8422110:CompanyLogoURL?AWSAccessKeyId=AKIAIKIUKM3HBSWUGCNQ&Expires=2147483647&Signature=YnXe2htGB0u1tfsU6Vd6XLw8dgo%3D" alt="Think Technologies" /></a>
              ...
              <div className="items-center md:flex">
                <div className="flex flex-col mt-2 md:flex-row md:mt-0 md:mx-1">
                  ...
                  <Link className="my-1 text-sm leading-5 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-indigo-400 hover:underline md:mx-4 md:my-0" to="/">Home</Link>
                  <Link className="my-1 text-sm leading-5 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-indigo-400 hover:underline md:mx-4 md:my-0" to="about">About</Link>
                  <Link className="my-1 text-sm leading-5 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-indigo-400 hover:underline md:mx-4 md:my-0" to="services">Services</Link>
                  <Link className="my-1 text-sm leading-5 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-indigo-400 hover:underline md:mx-4 md:my-0" to="portfolio">Portfolio</Link>
                ...
                <div className="flex items-center py-2 -mx-1 md:mx-0">
                  ...
                  <a className="block w-1/2 px-3 py-2 mx-1 text-sm font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-yellow-400 rounded-md hover:bg-blue-600 md:mx-0 md:w-auto" href="#">Join free</a>
                </div>
      ...
      {/*
       ...
       <Route path="./Router/Portfolio">
       <Portfolio />
       </Route>
       <Route path="./Router/About">
       <About />
       </Route>
       <Route path="../Router/Services">
       <Services />
       </Route>
       </Switch>
      */}
